...
var MARGIN_TOP=60;
var MARGIN_LEFT=30;
//const endTime=new Date(2016,3,15,23,00,00);//月份参数比较特殊，从0开始
var d = new Date();
var endTime=d.getTime()+3600000*24;
...
function addBalls(x,y,num){
	var length1=digit[num].length;
	for(var i=0;i<length1;i++){
		var length2=digit[num][i].length;
